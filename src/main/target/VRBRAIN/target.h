...
#define USBD_PRODUCT_STRING "VRBRAIN"
...
#define UART1_AHB1_PERIPHERALS RCC_APB2Periph_USART1
...
#define DEFAULT_FEATURES        (FEATURE_VBAT | FEATURE_ONESHOT125)

...
const timerHardware_t timerHardware[USABLE_TIMER_CHANNEL_COUNT] = {
    { TIM8,  IO_TAG(PC7),  TIM_Channel_2, TIM8_CC_IRQn,        0, IOCFG_IPD,      GPIO_AF_TIM8  },  // PPM (5th pin on FlexiIO port)
    { TIM12, IO_TAG(PB14), TIM_Channel_1, TIM8_BRK_TIM12_IRQn, 0, IOCFG_IPD,      GPIO_AF_TIM12 },  // S2_IN
    { TIM12, IO_TAG(PB15), TIM_Channel_2, TIM8_BRK_TIM12_IRQn, 0, IOCFG_IPD,      GPIO_AF_TIM12 },  // S3_IN
    { TIM8,  IO_TAG(PC8),  TIM_Channel_3, TIM8_CC_IRQn,        0, IOCFG_IPD,      GPIO_AF_TIM8  },  // S4_IN
    { TIM8,  IO_TAG(PC9),  TIM_Channel_4, TIM8_CC_IRQn,        0, IOCFG_IPD,      GPIO_AF_TIM8  },  // S5_IN
